    ...
    return (
        <div className="max-w-screen-sm px-8 mx-auto flex flex-col items-center">
            ...
            <p className="text-center my-4">
                ...
                Music (21M). I did my thesis research co-advised by Jordan Cotler and Anand Natarajan, and in the past I&apos;ve worked at Los Alamos National Lab and in Isaac Chuang&apos;s lab.
